...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    if (self.doLogin)//登录转场动画
    {
        ...
        //转场的来源控制器
        TabBarController* toVC = (TabBarController *)[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
        //转场去往的控制器
...
//        [containerView addSubview:fromVC.LoginWord];
         [containerView addSubview:fromVC.image1];
        
//        CGFloat proportion = toVC.navWord.yy_width / fromVC.LoginWord.yy_width;
         CGFloat proportion = toVC.navWord.yy_width / fromVC.image1.yy_width;
...
//        [fromVC.LoginWord.layer addAnimation:LoginWordScale forKey:LoginWordScale.keyPath];
        [fromVC.image1.layer addAnimation:LoginWordScale forKey:LoginWordScale.keyPath];
        ...
        [UIView animateWithDuration:0.4 delay:0.15 options:UIViewAnimationOptionCurveEaseInOut animations:^{
            fromVC.image1.yy_centerX = newPosition.x;
            fromVC.image1.yy_centerY = newPosition.y;
        } completion:^(BOOL finished) {
        ...
        CGFloat originalX = toVC.view.yy_width/2-bntSize/2;
        CGFloat originalY = toVC.view.yy_height/2+320;
    ...
    else//退出登录转场动画
    {
        ...
        //转场去往的控制器
        TabBarController* fromVC = (TabBarController *)[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
