...
- (void)SetupUIComponent {
    ...
    //logo布局
    self.LoginImage.frame = CGRectMake(0, 0, YYScreenW, YYScreenH);
    //按钮布局
...
//    设置btn的位置
    _forgetButton.frame = CGRectMake(YYScreenW * 0.18,YYScreenH * 0.9,80,30);
    
    [_forgetButton setTitle:@"忘记密码" forState:UIControlStateNormal];
    _forgetButton.titleLabel.font = [UIFont systemFontOfSize: 16.0];
    [_forgetButton setBackgroundColor: BG_COLOR];
//    设置字体颜色
...
//    设置中间的label
    _label1 = [[UILabel alloc]initWithFrame:CGRectMake(YYScreenW * 0.49,YYScreenH * 0.905,10,20)];
    _label1.text = @"|";
...
- (UIImageView *)LoginImage
{
    if (!_LoginImage)
    {
        _LoginImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"11.png"]];
...
//         _LoginWord.font =  [UIFont fontWithName:@"楷体" size:134.0f];
...
//        _image1.image = [UIImage imageNamed:@"111"];
//        _image1.frame = CGRectMake(200, 200, 20, 30);
//    }
//    return _image1;
//}
- (UIButton *)GetButton
...
//        _landButton.frame = CGRectMake(0, 0, 0, 0);
//        _landButton.hidden = NO;
//        [_landButton.layer setMasksToBounds:YES];
//        [_landButton.layer setCornerRadius:12.0];
//        [_landButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
//        [_landButton setTitle:@"登录" forState:UIControlStateNormal];
//        _landButton.backgroundColor = ButtonColor;
//        [_landButton addTarget:self action:@selector(LoginButtonClick) forControlEvents:UIControlEventTouchUpInside];
//    }
//    return _landButton;
//}
